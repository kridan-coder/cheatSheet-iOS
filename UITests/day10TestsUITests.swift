...
class day10TestsUITests: XCTestCase {
    ...
    func testLogin() throws {
        let validEmail = "tester@gmail.com"
        let validPassword = "qwerty1111"
        ...
        expectation(for: NSPredicate(format: "exists == true"), evaluatedWith: table, handler: nil)
